    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var serviceProvider = new ServiceCollection()
                ...
                .AddSingleton<ICurrenciesService, CurrenciesService>()
                .BuildServiceProvider();

            var service = serviceProvider.GetService<ICurrenciesService>();
            var logger = serviceProvider.GetService<ILogger<CurrenciesModel>>();

            CurrenciesModel model = new CurrenciesModel(logger, service, company, configuration);
            model.ProcessData();
        }
    }
}
